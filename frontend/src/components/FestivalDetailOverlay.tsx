...
interface FestivalDetailOverlayProps {
  festivalId: string;
  onClose: () => void;
}

const FestivalDetailOverlay: React.FC<FestivalDetailOverlayProps> = ({ festivalId, onClose }) => {
  const { user } = useAuth();
...
export default FestivalDetailOverlay;
